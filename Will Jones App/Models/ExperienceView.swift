            ...
            VStack
            {
                ...
                VStack(alignment: .leading)
                {
                    ...
                    Text("Java")
                        .font(.subheadline)
                        .fontWeight(.semibold)
                    // Not sure how to make this link open in webview while being
                    // inline with the text
                    Text("Developed games and other software. Notable projects include: Pong, Snake, and a database to store Snapchat conversations, password manager, an implementation of my own [encryption algorithm](https://chiefwithcolorfulshoes.com/blog/Elite_Encryption_Algorithm/), and an operating system like program equipped with email and internet capabilities as well as other features.")
                        .font(.footnote)
                        .padding(5)
                    Text("C/C++")
                        .font(.subheadline)
